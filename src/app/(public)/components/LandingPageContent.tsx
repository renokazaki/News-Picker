        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col justify-center gap-4 sm:flex-row lg:justify-start">
              <Link href="/sign-up">
                <Button className="cursor-pointer flex w-full items-center justify-center gap-2 rounded-lg bg-gray-600 px-8 py-4 text-lg font-semibold text-white transition-colors hover:bg-gray-700 sm:w-auto">
                  新規登録
                  <ArrowRight className="h-5 w-5" />
                </Button>
              </Link>
              <Link href="/sign-in">
                <Button className="cursor-pointer flex w-full items-center justify-center gap-2 rounded-lg bg-blue-600 px-8 py-4 text-lg font-semibold text-white transition-colors hover:bg-blue-700 sm:w-auto">
                  ログイン
                  <ArrowRight className="h-5 w-5" />
                </Button>
              </Link>
